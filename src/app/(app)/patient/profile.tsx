...
// Componente principal que exibe o perfil do paciente
export default function PatientProfile() {
  // Hooks para gerenciar autenticação e estado do modal de logout
  const { user, logout } = useAuth();
  const [showLogoutModal, setShowLogoutModal] = useState(false);

  // Query para buscar dados do perfil do paciente
  ...
  // Retorna null se não houver perfil ou se o usuário não for paciente
  if (!profile || user?.role !== "patient") return null;

  // Array com os itens do perfil e suas configurações de exibição
  const profileItems = [
    {
      icon: "person",
      label: "Nome",
  ...
  // Renderiza a interface do perfil do paciente
  return (
