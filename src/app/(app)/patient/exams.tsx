...
// Componente principal que exibe os exames do paciente
export default function PatientExams() {
  ...
  // Busca os exames de Chagas do paciente
  ...
  // Retorna a configuração de estilo e ícone baseado no status do exame
  ...
  // Renderiza a lista de exames de Chagas
  ...
  // Renderiza a lista de exames complementares
  ...
  // Renderiza a tela principal com os exames
  return (
    <SafeAreaView className="flex-1 bg-background">
